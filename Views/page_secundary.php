...
<!-- botão search -->
	<header>
		<div class="search-container">
			<div class="userAndLogout">
				...
				<select 
					...
					id="options" 
					name="options" 
					<?php echo ($_SESSION['type'] === 'adminNap') ? '' : 'hidden'; ?>>
		...
		<h1 class='napTitle'> Núcleo de Apoio Psicopedagógico</h1>
		<nav class='navSecundary'>
			<ul>
		...
		<footer>
			...
			<div>
				...
				nap@univicosa.com.br
			</div>
			<div>
				<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-geo-alt-fill" viewBox="0 0 16 16">
				<path d="M8 16s6-5.686 6-10A6 6 0 0 0 2 6c0 4.314 6 10 6 10zm0-7a3 3 0 1 1 0-6 3 3 0 0 1 0 6z"/>
				</svg>
				Núcleo de Apoio Psicopedagógico, sala 01 e 02 do NAP/Univiçosa
			</div>
			<div>
				<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-clock-fill" viewBox="0 0 16 16">
				<path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM8 3.5a.5.5 0 0 0-1 0V9a.5.5 0 0 0 .252.434l3.5 2a.5.5 0 0 0 .496-.868L8 8.71V3.5z"/>
				</svg> 
				Segunda a Quinta-feira de 07:00 ás 22:00 e Sexta-feira de 07:00 ás 18:00.
			</div>
			<hr>
